...
public class PostController {
    ...
    // 예를 들어 생성자에서 바로 쓴다거나 아니면 서비스, 레포지토리 어노테이션을 안붙였거나
//    private final PostService postService;
    ...
    // 필욯나 곳이 있으면 꺼내서 넣어줌
    // ioc 컨테이너에서 해당 객체를 찾아서 자동으로 넣어주니까 우리는 new할 필요가 없다
    // 이미 실행될 때 ioc 컨테이너에 객체들이 생성되서 보관되어있다.
